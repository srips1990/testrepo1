...
$user_details = $crudEngine->getUserDetailsByUserId($user_id);
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                     ...
                     <ul class="dropdown-menu dropdown-alerts">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i> Name:  <?php echo $user_details['user_name']; ?> </a></li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class='nav nav-second-level'>
                                <li><a href='invite_member.php'>Invite Member</a></li>
                                <li><a href='search.php'>Search member</a></li>
                                <li><a href='members_list.php'>Members Masterlist</a></li>
                            </ul>
                        </li>
